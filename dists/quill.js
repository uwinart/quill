...
Delta.prototype.insert = function (text, attributes) {
  ...
  if (is.object(attributes) && Object.keys(attributes).length > 0) {
    if (typeof attributes.font !== 'undefined') {
...
ImageTooltip = (function(superClass) {
  ...
  ImageTooltip.DEFAULTS = {
    template: '<input class="input" type="textbox"> <div class="preview"> <span>Предпросмотр</span> </div> <a href="javascript:;" class="cancel">Отмена</a> <a href="javascript:;" class="insert">Вставить</a>'
  };
  ...
  ImageTooltip.prototype.insertImage = function() {
    ...
    if (this.range) {
      this.preview.innerHTML = '<span>Предпросмотр</span>';
      this.textbox.value = '';
...
LinkTooltip = (function(superClass) {
  ...
  LinkTooltip.DEFAULTS = {
    maxLength: 50,
    template: '<span class="title">Перейти по URL:&nbsp;</span> <a href="#" class="url" target="_blank" href="about:blank"></a> <input class="input" type="text"> <span>&nbsp;&#45;&nbsp;</span> <a href="javascript:;" class="change">Изменить</a> <a href="javascript:;" class="remove">Удалить</a> <a href="javascript:;" class="done">Готово</a>'
  };
...
PasteManager = (function() {
  ...
  PasteManager.prototype._onConvert = function(container) {
    ...
    // console.log(delta.compose(new Delta().retain(lengthAdded - 1)["delete"](1)));
